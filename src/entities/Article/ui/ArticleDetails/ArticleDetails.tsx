...
export const ArticleDetails: FC<IArticleDetailsProps> = ({
    className,
    id
}) => {
    ...
    return (
        <div data-testid={'ArticleDetails'} className={classNames(styles.articleDetails, {}, [className])}>
            ...
            <div className={styles.infoBlock}>
                <Icon Svg={EyeIcon} withRightMargin />
                <Text>{article?.views}</Text>
            </div>
            <div className={styles.infoBlock}>
                <Icon Svg={CalendarIcon} withRightMargin />
