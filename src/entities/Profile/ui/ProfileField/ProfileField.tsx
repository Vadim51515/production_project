...
import { profileFieldErrorSelector, profileFieldValue, profileIsReadonlySelector } from '../../model/selectors/selectors';
...
export const ProfileField: FC<TProfileFieldProps> = ({ fieldType = 'input', fieldName, label, isRequired, ...props }) => {
