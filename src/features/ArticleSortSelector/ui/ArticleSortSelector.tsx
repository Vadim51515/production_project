...
import { type Func, type IOption, type TOptions, type TSortOrder } from '../../../app/types';
...
export const ArticleSortSelector: FC<IArticleSortSelectorProps> = ({ className, onChangeSort, sort, onChangeOrder, order }) => {
