...
import { ArticleType, type IArticle, type TArticleViewType } from '../../../../entities/Article';
...
export const { reducer: articlesPageReducer, actions: articlesPageSliceActions } = createSlice({
    name: 'articlesPage',
